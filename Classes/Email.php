...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = 'f8eeb5f357d0d0';
        $mail->Password = '96284dd6dc9d0c';
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong> Has creado tu cuenta en UptTask, solo debes confirmarla en el siguiente enlace</p>";
